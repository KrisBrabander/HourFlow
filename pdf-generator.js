...
const pdfGenerator = {
    ...
    // Minimalistic styling for clean, professional PDFs
    styles: {
        colors: {
            primary: [60, 60, 60],         // Dark gray (more minimalistic)
            secondary: [120, 120, 120],    // Medium gray
            accent: [180, 180, 180],       // Light gray
            text: [40, 40, 40],            // Near black
        ...
        fontSize: {
            title: 20,                     // Smaller title
            subtitle: 14,                  // Smaller subtitle
            heading: 12,                   // Smaller heading
            subheading: 11,                // Smaller subheading
            body: 10,                      // Same body text
            small: 8                       // Same small text
        },
        spacing: {
            margin: 15,                    // Smaller margins
